//
//  CalenderCollectionViewController.swift
//  Pray4Me
//
...
protocol PrayerCalenderViewDataSource {
	func startDate() -> NSData?
	func endDate() -> NSData?
}

protocol PrayerCalenderViewDelegate {
...
class PrayerCalenderCollectionViewController: UICollectionViewController {
