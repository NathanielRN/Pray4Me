...
class PrayerFeelingPickerController: UITableViewController {
    ...
    override func viewDidLoad() {
		...
		feelings = ["Thinking", "Tired", "Worried", "Encouraged", "Joyful", "Trusting", "Wating"]
		...
		selectedIndex = (feelings as Array).index(of: self.feelingChoice)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		...
		cell.textLabel?.text = self.feelings[indexPath.row]
    ...
    */
	...
	override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
		...
		cell?.accessoryType = UITableViewCellAccessoryType.checkmark
		let chosenFeeling = self.feelings[indexPath.row]
